...
//    @BindView(R.id.tv_item_about_safe_name)
//    TextView tvItemAboutSafeName;
//    @BindView(R.id.tv_item_about_safe_relate)
//    TextView tvItemAboutSafeRelate;
...
//                    View view = View.inflate(detailsActivity.this, R.layout.lay_comment_item_ex, null);
                    ...
                    Glide.with(detailsActivity.this).load(items.get(1).getAuthorPortrait()).into(iv_avatar);
